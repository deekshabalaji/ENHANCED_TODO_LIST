...
public class DBHelper extends SQLiteOpenHelper{
    ...
    public void onCreate(SQLiteDatabase db) {
        //added the two columns of contract into the querystring of the database
        String queryString = "CREATE TABLE " + Contract.TABLE_TODO.TABLE_NAME + " ("+
                ...
                Contract.TABLE_TODO.COLUMN_NAME_CATEGORIES + " TEXT, " +
                Contract.TABLE_TODO.COLUMN_NAME_TASK + " TEXT" +"); ";
        Log.d(TAG, "Create table SQL: " + queryString);
        db.execSQL(queryString);
    }
    @Override
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        //uncommented this line did by Pfr
